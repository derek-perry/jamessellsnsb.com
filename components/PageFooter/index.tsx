      ...
      <footer className="bg-[#252162] text-white text-xl w-full shadow-[0_-5px_5px_0px_rgba(0,0,0,0.1)]">
        <div className="pt-16 pb-12 px-9 flex flex-col gap-y-10 text-center items-center justify-center">
          ...
          <div className="flex flex-row flex-wrap gap-x-8 gap-y-2 text-center items-center justify-center">
              <p>Email: <LinkExternal className="!text-white focus:!text-slate-400 hover:!text-slate-300 no-underline break-all" href="mailto:contact@jamessellsnsb.com" title="Contact James Cumiskey via Email at Contact@JamesSellsNSB.com">Contact@JamesSellsNSB.com</LinkExternal></p>
              <p>Phone: <LinkExternal className="!text-white focus:!text-slate-400 hover:!text-slate-300 no-underline break-all" href="tel:3864449116" title="Contact James Cumiskey via Phone at 386-444-9116">386-444-9116</LinkExternal></p>
          </div>
          <div className="flex flex-row flex-wrap gap-x-8 gap-y-2 text-center items-center justify-center">
